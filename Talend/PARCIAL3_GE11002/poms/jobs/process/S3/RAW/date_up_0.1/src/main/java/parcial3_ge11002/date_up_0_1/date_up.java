...
package parcial3_ge11002.date_up_0_1;
...
/**
 * Job: date_up Purpose: date_up<br>
 * Description: date_up <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class date_up implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "date_up";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(date_up.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tS3Connection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:S0HmNMlghKVqNJMQCAinQfX6WBfzNLdYHQzf5xvPrhXqir4luCyY3W7tlyTMFd/JrZ8Iz02q5WINryP7GPu9Tkuly7A=");
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add("CatalogDate-2020.csv");  
 ...
 */
    ...
    public static void main(String[] args){
        final date_up date_upClass = new date_up();

        int exitCode = date_upClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = date_up.class.getClassLoader().getResourceAsStream("parcial3_ge11002/date_up_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = date_up.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : date_up");
        }
...
/************************************************************************************************
 *     45591 characters generated by Talend Open Studio for Data Integration 
