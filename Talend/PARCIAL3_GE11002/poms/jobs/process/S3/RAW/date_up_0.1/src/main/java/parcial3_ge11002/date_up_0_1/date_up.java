...
public class date_up implements TalendJob {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:fVqLR4QOxM8NwPH8qnsmOCGmjvRhdViikV5I2CCrmAw7e36ivGfYTyqjvNhhhopiWICXJ/YRs5zCLIckgciiT/iMGxw=");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = date_up.class.getClassLoader()
					.getResourceAsStream("parcial3_ge11002/date_up_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = date_up.class.getClassLoader()
...
/************************************************************************************************
 * 45591 characters generated by Talend Open Studio for Data Integration on the
 * October 26, 2023, 8:17:49 PM CST
 ************************************************************************************************/