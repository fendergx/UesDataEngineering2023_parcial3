...
package parcial3_ge11002.uploadfiles_0_1;
...
/**
 * Job: UploadFiles Purpose: UploadFiles<br>
 * Description: UploadFiles <br>
 * 
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status
 */
public class UploadFiles implements TalendJob {
	...
	private final String jobName = "UploadFiles";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(UploadFiles.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				parcial3_ge11002.airlines_up_0_1.Airlines_up childJob_tRunJob_1 = new parcial3_ge11002.airlines_up_0_1.Airlines_up();
				// pass DataSources
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				parcial3_ge11002.date_up_0_1.date_up childJob_tRunJob_2 = new parcial3_ge11002.date_up_0_1.date_up();
				// pass DataSources
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				parcial3_ge11002.flight_up_0_1.flight_up childJob_tRunJob_3 = new parcial3_ge11002.flight_up_0_1.flight_up();
				// pass DataSources
	...
	public static void main(String[] args) {
		final UploadFiles UploadFilesClass = new UploadFiles();

		int exitCode = UploadFilesClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = UploadFiles.class.getClassLoader()
					.getResourceAsStream("parcial3_ge11002/uploadfiles_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = UploadFiles.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : UploadFiles");
		}
...
/************************************************************************************************
 * 44026 characters generated by Talend Open Studio for Data Integration on the
 * October 29, 2023, 12:29:45 PM CST
 ************************************************************************************************/