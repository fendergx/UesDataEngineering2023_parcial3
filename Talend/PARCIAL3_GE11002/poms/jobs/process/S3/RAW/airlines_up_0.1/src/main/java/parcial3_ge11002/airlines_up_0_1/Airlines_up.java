...
package parcial3_ge11002.airlines_up_0_1;
...
/**
 * Job: Airlines_up Purpose: Airlines_up<br>
 * Description: Airlines_up <br>
 * 
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status
 */
public class Airlines_up implements TalendJob {
	...
	private final String jobName = "Airlines_up";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Airlines_up.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:grE2yXxFcWF7x+MYUhuk2Nf/BiZ4y8e6mIzCNoBFDfu6idMRCPZlujE0f8pU+DovcVuEdKQAm1rS8hMSnz21HSXfMAg=");
	...
	public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				maskList_tFileList_1.add("Airlines.csv");
				...
				for (int i_tFileList_1 = 0; i_tFileList_1 < list_tFileList_1.size(); i_tFileList_1++) {
					...
					Object fileOrStream_tS3Put_1 = "C:/Parcial3/RAW/"
					...
					try {
						...
						if (!useStream_tS3Put_1) {
							...
							com.amazonaws.services.s3.model.PutObjectRequest putRequest_tS3Put_1 = new com.amazonaws.services.s3.model.PutObjectRequest(
									"parcial3bucket/DW/RAW", key_tS3Put_1, inputFile_tS3Put_1)
							...
							if (!multiUpload_tS3Put_1) {
								...
								com.amazonaws.services.s3.model.PutObjectRequest putRequest_tS3Put_1 = new com.amazonaws.services.s3.model.PutObjectRequest(
										"parcial3bucket/DW/RAW", key_tS3Put_1, uploadStream_tS3Put_1,
								...
								com.amazonaws.services.s3.model.InitiateMultipartUploadRequest putRequest_tS3Put_1 = new com.amazonaws.services.s3.model.InitiateMultipartUploadRequest(
										"parcial3bucket/DW/RAW", key_tS3Put_1, objectMetadata_tS3Put_1);
								...
								try {
									while (streamHasNext_tS3Put_1) {
										com.amazonaws.services.s3.model.UploadPartRequest uploadRequest_tS3Put_1 = new com.amazonaws.services.s3.model.UploadPartRequest()
												.withBucketName("parcial3bucket/DW/RAW").withKey(key_tS3Put_1)
									...
									com.amazonaws.services.s3.model.CompleteMultipartUploadRequest compRequest_tS3Put_1 = new com.amazonaws.services.s3.model.CompleteMultipartUploadRequest(
											"parcial3bucket/DW/RAW", key_tS3Put_1, uploadId_tS3Put_1,
											partTags_tS3Put_1);
	...
	public static void main(String[] args) {
		final Airlines_up Airlines_upClass = new Airlines_up();

		int exitCode = Airlines_upClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Airlines_up.class.getClassLoader()
					.getResourceAsStream("parcial3_ge11002/airlines_up_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Airlines_up.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Airlines_up");
		}
...
/************************************************************************************************
 * 45647 characters generated by Talend Open Studio for Data Integration on the
 * October 26, 2023, 8:19:55 PM CST
 ************************************************************************************************/