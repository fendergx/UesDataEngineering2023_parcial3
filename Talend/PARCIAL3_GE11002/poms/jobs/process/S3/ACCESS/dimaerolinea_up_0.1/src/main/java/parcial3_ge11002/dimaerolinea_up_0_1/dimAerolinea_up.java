...
package parcial3_ge11002.dimaerolinea_up_0_1;
...
/**
 * Job: dimAerolinea_up Purpose: dimAerolinea_up<br>
 * Description: dimAerolinea_up <br>
 * 
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status
 */
public class dimAerolinea_up implements TalendJob {
	...
	private final String jobName = "dimAerolinea_up";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					dimAerolinea_up.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(dimAerolinea_up.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:wJOHjqUukjBCGPsqoBfU9+lC+YBnm1dZKnHxqZOPyWxZIycdybNFrixiqOYVGtaEhouO2gRabMzrbnQcZ74bIjcxvGg=");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_1 = new com.amazonaws.services.s3.model.GetObjectRequest(
							"parcial3bucket/DW/Processing", "airlines.csv");

					com.amazonaws.services.s3.transfer.Download download_tS3Get_1 = tm_tS3Get_1.download(
							getObjectRequest_tS3Get_1, new java.io.File("C:/Parcial3/Processing/airlines.csv"), null,
							0l, true);
	...
	public static class aerolineaStruct implements routines.system.IPersistableRow<aerolineaStruct> {
		final static byte[] commonByteArrayLock_PARCIAL3_GE11002_dimAerolinea_up = new byte[0];
		static byte[] commonByteArray_PARCIAL3_GE11002_dimAerolinea_up = new byte[0];

		public int airlineKey;

		public int getAirlineKey() {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PARCIAL3_GE11002_dimAerolinea_up.length) {
					if (length < 1024 && commonByteArray_PARCIAL3_GE11002_dimAerolinea_up.length == 0) {
						commonByteArray_PARCIAL3_GE11002_dimAerolinea_up = new byte[1024];
					} else {
						commonByteArray_PARCIAL3_GE11002_dimAerolinea_up = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PARCIAL3_GE11002_dimAerolinea_up, 0, length);
				strReturn = new String(commonByteArray_PARCIAL3_GE11002_dimAerolinea_up, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PARCIAL3_GE11002_dimAerolinea_up, 0, length);
				strReturn = new String(commonByteArray_PARCIAL3_GE11002_dimAerolinea_up, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PARCIAL3_GE11002_dimAerolinea_up) {

				try {

					int length = 0;

					this.airlineKey = dis.readInt();
		 ...
		 * Compare keys
		 */
		public int compareTo(aerolineaStruct other) {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				aerolineaStruct aerolinea = new aerolineaStruct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "aerolinea");
				}

				int tos_count_tFileOutputDelimited_1 = 0;

				String fileName_tFileOutputDelimited_1 = "";
				fileName_tFileOutputDelimited_1 = (new java.io.File("C:/Parcial3/Access/dimAerolinea.csv"))
...
// # Outputs initialization
				aerolineaStruct aerolinea_tmp = new aerolineaStruct();
// ###############################
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "C:/Parcial3/Processing/airlines.csv";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"C:/Parcial3/Processing/airlines.csv", "UTF-8", ";", "\n", false, 1, 0,
...
// Start of branch "row1"
						if (row1 != null) {
							...
							{ // start of Var scope
								...
								Var.airlineKey = Numeric.sequence("s1", 1, 1);// ###############################
								// ###############################
								// # Output tables

								aerolinea = null;

// # Output table : 'aerolinea'
								aerolinea_tmp.airlineKey = Var.airlineKey;
								aerolinea_tmp.airlineID = row1.Code;
								aerolinea_tmp.Description = row1.Description;
								aerolinea = aerolinea_tmp;
// ###############################
...
// Start of branch "aerolinea"
							if (aerolinea != null) {
								...
								sb_tFileOutputDelimited_1.append(aerolinea.airlineKey);
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (aerolinea.airlineID != null) {
									sb_tFileOutputDelimited_1.append(aerolinea.airlineID);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (aerolinea.Description != null) {
									sb_tFileOutputDelimited_1.append(aerolinea.Description);
								}
					...
					if (!((Object) ("C:/Parcial3/Processing/airlines.csv") instanceof java.io.InputStream)) {
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "aerolinea");
				}
	...
	public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				maskList_tFileList_1.add("dimAerolinea.csv");
	...
	public static void main(String[] args) {
		final dimAerolinea_up dimAerolinea_upClass = new dimAerolinea_up();

		int exitCode = dimAerolinea_upClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dimAerolinea_up.class.getClassLoader()
					.getResourceAsStream("parcial3_ge11002/dimaerolinea_up_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = dimAerolinea_up.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : dimAerolinea_up");
		}
...
/************************************************************************************************
 * 83950 characters generated by Talend Open Studio for Data Integration on the
 * October 29, 2023, 9:44:45 PM CST
 ************************************************************************************************/