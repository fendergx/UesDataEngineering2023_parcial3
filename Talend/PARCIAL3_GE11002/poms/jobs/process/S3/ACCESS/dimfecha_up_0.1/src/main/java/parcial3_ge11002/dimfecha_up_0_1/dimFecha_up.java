...
package parcial3_ge11002.dimfecha_up_0_1;
...
/**
 * Job: dimFecha_up Purpose: dimFecha_up<br>
 * Description: dimFecha_up <br>
 * 
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status
 */
public class dimFecha_up implements TalendJob {
	...
	private final String jobName = "dimFecha_up";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(dimFecha_up.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tS3Close_1_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tS3Close_1_onSubJobError(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:fu1oiETSrGfLeVDfz+oFYa+gBbqg5gntnK5i9TwpaN+j5btUQyRQQ8dykdewBTiDqx/m1iJedSonnWHNFJjUlzStDrY=");

				com.amazonaws.auth.AWSCredentials credentials_tS3Connection_1 = new com.amazonaws.auth.BasicAWSCredentials(
						"AKIARLWOKCXMHO52373H", decryptedPassword_tS3Connection_1);
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_1 = new com.amazonaws.services.s3.model.GetObjectRequest(
							"parcial3bucket/DW/Processing", "dates.csv");

					com.amazonaws.services.s3.transfer.Download download_tS3Get_1 = tm_tS3Get_1.download(
							getObjectRequest_tS3Get_1, new java.io.File("C:/Parcial3/Processing/dates.csv"), null, 0l,
							true);
	...
	public static class fechaStruct implements routines.system.IPersistableRow<fechaStruct> {
		final static byte[] commonByteArrayLock_PARCIAL3_GE11002_dimFecha_up = new byte[0];
		static byte[] commonByteArray_PARCIAL3_GE11002_dimFecha_up = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PARCIAL3_GE11002_dimFecha_up.length) {
					if (length < 1024 && commonByteArray_PARCIAL3_GE11002_dimFecha_up.length == 0) {
						commonByteArray_PARCIAL3_GE11002_dimFecha_up = new byte[1024];
					} else {
						commonByteArray_PARCIAL3_GE11002_dimFecha_up = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PARCIAL3_GE11002_dimFecha_up, 0, length);
				strReturn = new String(commonByteArray_PARCIAL3_GE11002_dimFecha_up, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PARCIAL3_GE11002_dimFecha_up, 0, length);
				strReturn = new String(commonByteArray_PARCIAL3_GE11002_dimFecha_up, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PARCIAL3_GE11002_dimFecha_up) {
				...
				try {
					...
					this.diaDeSemana = readInteger(dis);

					this.numDiaEnMes = readInteger(dis);

					this.mes = readInteger(dis);

					this.nombreMes = readString(dis);

					this.numSemanaEnMes = readInteger(dis);

					this.numSemanaEnAnio = readInteger(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.diaDeSemana, dos);

				// Integer

				writeInteger(this.numDiaEnMes, dos);
				...
				writeInteger(this.numSemanaEnMes, dos);

				// Integer

				writeInteger(this.numSemanaEnAnio, dos);
		 ...
		 * Compare keys
		 */
		public int compareTo(fechaStruct other) {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fechaStruct fecha = new fechaStruct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "fecha");
				}

				int tos_count_tFileOutputDelimited_1 = 0;

				String fileName_tFileOutputDelimited_1 = "";
				fileName_tFileOutputDelimited_1 = (new java.io.File("C:/Parcial3/Access/dimFecha.csv"))
...
// # Outputs initialization
				fechaStruct fecha_tmp = new fechaStruct();
// ###############################
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "C:/Parcial3/Processing/dates.csv";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"C:/Parcial3/Processing/dates.csv", "UTF-8", ";", "\n", false, 1, 0,
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											...
											"date_key", "row1", temp, ex_tFileInputDelimited_1),
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"day_num_in_month", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"week_num_in_month", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"week_num_in_year", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"weekday_flag", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
...
// # Output table : 'fecha'
								fecha_tmp.fechaKey = row1.date_key;
								fecha_tmp.fullDate = row1.full_date;
								fecha_tmp.nombreDia = row1.day_name;
								fecha_tmp.diaDeSemana = row1.day_of_week;
								fecha_tmp.numDiaEnMes = row1.day_num_in_month;
								fecha_tmp.mes = row1.month;
								fecha_tmp.nombreMes = row1.month_name;
								fecha_tmp.numSemanaEnMes = row1.week_num_in_month;
								fecha_tmp.numSemanaEnAnio = row1.week_num_in_year;
								fecha_tmp.trimestre = row1.quarter;
								fecha_tmp.nombreTrimestre = row1.quarter_name;
								fecha_tmp.diaLaboral = row1.weekday_flag;
								fecha_tmp.anio = row1.year;
								fecha = fecha_tmp;
// ###############################
...
// Start of branch "fecha"
							if (fecha != null) {
								...
								if (fecha.fechaKey != null) {
									sb_tFileOutputDelimited_1.append(fecha.fechaKey);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (fecha.fullDate != null) {
									sb_tFileOutputDelimited_1.append(fecha.fullDate);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (fecha.nombreDia != null) {
									sb_tFileOutputDelimited_1.append(fecha.nombreDia);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (fecha.diaDeSemana != null) {
									sb_tFileOutputDelimited_1.append(fecha.diaDeSemana);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (fecha.numDiaEnMes != null) {
									sb_tFileOutputDelimited_1.append(fecha.numDiaEnMes);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (fecha.mes != null) {
									sb_tFileOutputDelimited_1.append(fecha.mes);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (fecha.nombreMes != null) {
									sb_tFileOutputDelimited_1.append(fecha.nombreMes);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (fecha.numSemanaEnMes != null) {
									sb_tFileOutputDelimited_1.append(fecha.numSemanaEnMes);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (fecha.numSemanaEnAnio != null) {
									sb_tFileOutputDelimited_1.append(fecha.numSemanaEnAnio);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (fecha.trimestre != null) {
									sb_tFileOutputDelimited_1.append(fecha.trimestre);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (fecha.nombreTrimestre != null) {
									sb_tFileOutputDelimited_1.append(fecha.nombreTrimestre);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (fecha.diaLaboral != null) {
									sb_tFileOutputDelimited_1.append(fecha.diaLaboral);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (fecha.anio != null) {
									sb_tFileOutputDelimited_1.append(fecha.anio);
								}
					...
					if (!((Object) ("C:/Parcial3/Processing/dates.csv") instanceof java.io.InputStream)) {
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "fecha");
				}
	...
	public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String directory_tFileList_1 = "C:/Parcial3/Access";
				final java.util.List<String> maskList_tFileList_1 = new java.util.ArrayList<String>();
				final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>();
				maskList_tFileList_1.add("dimFecha.csv");
				...
				for (int i_tFileList_1 = 0; i_tFileList_1 < list_tFileList_1.size(); i_tFileList_1++) {
					...
					Object fileOrStream_tS3Put_1 = "C:/Parcial3/Access/"
					...
					try {
						...
						if (!useStream_tS3Put_1) {
							...
							com.amazonaws.services.s3.model.PutObjectRequest putRequest_tS3Put_1 = new com.amazonaws.services.s3.model.PutObjectRequest(
									"parcial3bucket/DW/Access", key_tS3Put_1, inputFile_tS3Put_1)
							...
							if (!multiUpload_tS3Put_1) {
								...
								com.amazonaws.services.s3.model.PutObjectRequest putRequest_tS3Put_1 = new com.amazonaws.services.s3.model.PutObjectRequest(
										"parcial3bucket/DW/Access", key_tS3Put_1, uploadStream_tS3Put_1,
								...
								com.amazonaws.services.s3.model.InitiateMultipartUploadRequest putRequest_tS3Put_1 = new com.amazonaws.services.s3.model.InitiateMultipartUploadRequest(
										"parcial3bucket/DW/Access", key_tS3Put_1, objectMetadata_tS3Put_1);
								...
								try {
									while (streamHasNext_tS3Put_1) {
										com.amazonaws.services.s3.model.UploadPartRequest uploadRequest_tS3Put_1 = new com.amazonaws.services.s3.model.UploadPartRequest()
												.withBucketName("parcial3bucket/DW/Access").withKey(key_tS3Put_1)
									...
									com.amazonaws.services.s3.model.CompleteMultipartUploadRequest compRequest_tS3Put_1 = new com.amazonaws.services.s3.model.CompleteMultipartUploadRequest(
											"parcial3bucket/DW/Access", key_tS3Put_1, uploadId_tS3Put_1,
											partTags_tS3Put_1);
	...
	public void tS3Close_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				com.amazonaws.services.s3.AmazonS3Client conn_tS3Close_1 = (com.amazonaws.services.s3.AmazonS3Client) globalMap
						.get("conn_tS3Connection_1");
	...
	public static void main(String[] args) {
		final dimFecha_up dimFecha_upClass = new dimFecha_up();

		int exitCode = dimFecha_upClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dimFecha_up.class.getClassLoader()
					.getResourceAsStream("parcial3_ge11002/dimfecha_up_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = dimFecha_up.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dimFecha_up");
		}
...
/************************************************************************************************
 * 107494 characters generated by Talend Open Studio for Data Integration on the
 * October 30, 2023, 12:12:15 AM CST
 ************************************************************************************************/