...
package parcial3_ge11002.upload_fact_0_1;
...
/**
 * Job: upload_fact Purpose: upload_fact<br>
 * Description: upload_fact <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class upload_fact implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "upload_fact";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(upload_fact.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tS3Connection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:tJ80MPzxZWuBp46wm5q+czrpcjLY4mm5CDGN1pJsIWIwT3OzGIuo7FwE6/tgEipYL4NiUeIXxJV3nyl6dX/M3wzi2Xo=");

            com.amazonaws.auth.AWSCredentials credentials_tS3Connection_1 = new com.amazonaws.auth.BasicAWSCredentials("AKIARLWOKCXMHO52373H",decryptedPassword_tS3Connection_1);
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add("factVuelo.csv");  
 ...
 */
	...
	Object fileOrStream_tS3Put_1 = "C:/Parcial3/Access/"+((String)globalMap.get("tFileList_1_CURRENT_FILE"));
    ...
    com.amazonaws.services.s3.model.ObjectMetadata objectMetadata_tS3Put_1 = new com.amazonaws.services.s3.model.ObjectMetadata();
		...
		if(!useStream_tS3Put_1) {
    		...
    		tm_tS3Put_1 = com.amazonaws.services.s3.transfer.TransferManagerBuilder
  			...
  			com.amazonaws.services.s3.model.PutObjectRequest putRequest_tS3Put_1 = new com.amazonaws.services.s3.model.PutObjectRequest("parcial3bucket/DW/Access", key_tS3Put_1, inputFile_tS3Put_1).withMetadata(objectMetadata_tS3Put_1);
      	...
      	S3StreamUtil streamUtil_tS3Put_1 = new S3StreamUtil();
    		...
    		if(!multiUpload_tS3Put_1) {
    				...
    				com.amazonaws.services.s3.model.PutObjectRequest putRequest_tS3Put_1 = new com.amazonaws.services.s3.model.PutObjectRequest("parcial3bucket/DW/Access", key_tS3Put_1, uploadStream_tS3Put_1, objectMetadata_tS3Put_1);
      			...
      			com.amazonaws.services.s3.model.InitiateMultipartUploadRequest putRequest_tS3Put_1 = new com.amazonaws.services.s3.model.InitiateMultipartUploadRequest("parcial3bucket/DW/Access", key_tS3Put_1, objectMetadata_tS3Put_1);
				...
				try {
					while (streamHasNext_tS3Put_1) {
                    	...
                    	.withBucketName("parcial3bucket/DW/Access")
            		...
            		com.amazonaws.services.s3.model.CompleteMultipartUploadRequest compRequest_tS3Put_1 = new com.amazonaws.services.s3.model.CompleteMultipartUploadRequest("parcial3bucket/DW/Access", key_tS3Put_1,
...
globalMap.put("tS3Put_1_ERROR_MESSAGE",uploadException_tS3Put_1.getMessage());
  							conn_tS3Put_1.abortMultipartUpload(new com.amazonaws.services.s3.model.AbortMultipartUploadRequest("parcial3bucket/DW/Access", key_tS3Put_1, uploadId_tS3Put_1));
 ...
 */
    ...
    public static void main(String[] args){
        final upload_fact upload_factClass = new upload_fact();

        int exitCode = upload_factClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = upload_fact.class.getClassLoader().getResourceAsStream("parcial3_ge11002/upload_fact_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = upload_fact.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : upload_fact");
        }
...
/************************************************************************************************
 *     45967 characters generated by Talend Open Studio for Data Integration 
 *     on the October 30, 2023, 12:27:14 AM CST
 ************************************************************************************************/