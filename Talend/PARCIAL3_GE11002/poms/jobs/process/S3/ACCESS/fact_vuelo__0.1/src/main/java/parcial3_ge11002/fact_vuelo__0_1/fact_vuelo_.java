...
package parcial3_ge11002.fact_vuelo__0_1;
...
/**
 * Job: fact_vuelo_ Purpose: fact_vuelo_<br>
 * Description: fact_vuelo_ <br>
 * 
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status
 */
public class fact_vuelo_ implements TalendJob {
	...
	private final String jobName = "fact_vuelo_";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(fact_vuelo_.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class xStruct implements routines.system.IPersistableRow<xStruct> {
		final static byte[] commonByteArrayLock_PARCIAL3_GE11002_fact_vuelo_ = new byte[0];
		static byte[] commonByteArray_PARCIAL3_GE11002_fact_vuelo_ = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PARCIAL3_GE11002_fact_vuelo_.length) {
					if (length < 1024 && commonByteArray_PARCIAL3_GE11002_fact_vuelo_.length == 0) {
						commonByteArray_PARCIAL3_GE11002_fact_vuelo_ = new byte[1024];
					} else {
						commonByteArray_PARCIAL3_GE11002_fact_vuelo_ = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PARCIAL3_GE11002_fact_vuelo_, 0, length);
				strReturn = new String(commonByteArray_PARCIAL3_GE11002_fact_vuelo_, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PARCIAL3_GE11002_fact_vuelo_, 0, length);
				strReturn = new String(commonByteArray_PARCIAL3_GE11002_fact_vuelo_, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PARCIAL3_GE11002_fact_vuelo_) {
				...
				try {
					...
					while (fid_tFileInputDelimited_3 != null && fid_tFileInputDelimited_3.nextRecord()) {
						...
						try {
							...
							row1.FlightDate = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.Flight_Number_Operating_Airline = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"Flight_Number_Operating_Airline", "row1", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.CRSDepTime = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"CRSDepTime", "row1", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.DepTime = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"DepTime", "row1", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.DepDelayMinutes = ParserUtils.parseTo_Integer(temp);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.DepDel15 = ParserUtils.parseTo_Integer(temp);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.WheelsOff = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"WheelsOff", "row1", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.WheelsOn = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"WheelsOn", "row1", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.CRSArrTime = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"CRSArrTime", "row1", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.ArrTime = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"ArrTime", "row1", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.ArrDelayMinutes = ParserUtils.parseTo_Integer(temp);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.ArrDel15 = ParserUtils.parseTo_Integer(temp);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.Cancelled = ParserUtils.parseTo_Integer(temp);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.Diverted = ParserUtils.parseTo_Integer(temp);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.CRSElapsedTime = ParserUtils.parseTo_Integer(temp);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.ActualElapsedTime = ParserUtils.parseTo_Integer(temp);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.AirTime = ParserUtils.parseTo_Integer(temp);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.Distance = ParserUtils.parseTo_Integer(temp);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.CarrierDelay = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"CarrierDelay", "row1", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
...
// Start of branch "row1"
						if (row1 != null) {
							...
							if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
								...
								row3HashKey.fullDate = row1.FlightDate;
							...
							if (tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
								...
								// and it contains more one result from keys : row2.airlineID = '" +
								// row2HashKey.airlineID + "'");
							} // G 071
							...
							{ // start of Var scope
								...
								Var.delayed = (row1.DepDelayMinutes == null) ? "no" : "si";// ###############################
								// ###############################
								// # Output tables
...
// # Output table : 'x'
									x_tmp.fechaKey = row3.fechaKey;
									x_tmp.airlineKey = row2.airlineKey;
									x_tmp.Flight_Number_Operating_Airline = row1.Flight_Number_Operating_Airline;
									x_tmp.OriginAirportID = row1.OriginAirportID;
									x_tmp.OriginCityName = row1.OriginCityName;
									x_tmp.OriginState = row1.OriginState;
									x_tmp.OriginStateName = row1.OriginStateName;
									x_tmp.DestAirportID = row1.DestAirportID;
									x_tmp.DestCityName = row1.DestCityName;
									x_tmp.DestState = row1.DestState;
									x_tmp.DestStateName = row1.DestStateName;
									x_tmp.CRSDepTime = row1.CRSDepTime;
									x_tmp.DepTime = row1.DepTime;
									x_tmp.delayed = Var.delayed;
									x_tmp.DepDelayMinutes = row1.DepDelayMinutes;
									x_tmp.ArrDelayMinutes = row1.ArrDelayMinutes;
									x_tmp.WheelsOff = row1.WheelsOff;
									x_tmp.WheelsOn = row1.WheelsOn;
									x_tmp.CRSArrTime = row1.CRSArrTime;
									x_tmp.ArrTime = row1.ArrTime;
									x_tmp.Cancelled = row1.Cancelled;
									x_tmp.Diverted = row1.Diverted;
									x_tmp.CRSElapsedTime = row1.CRSElapsedTime;
									x_tmp.ActualElapsedTime = row1.ActualElapsedTime;
									x_tmp.AirTime = row1.AirTime;
									x_tmp.CarrierDelay = row1.CarrierDelay;
									x_tmp.WeatherDelay = row1.WeatherDelay;
									x_tmp.NASDelay = row1.NASDelay;
									x_tmp.SecurityDelay = row1.SecurityDelay;
									x_tmp.LateAircraftDelay = row1.LateAircraftDelay;
									x_tmp.DivAirportLandings = row1.DivAirportLandings;
									x_tmp.DivReachedDest = row1.DivReachedDest;
									x_tmp.DivActualElapsedTime = row1.DivActualElapsedTime;
									x_tmp.DivArrDelay = row1.DivArrDelay;
									x = x_tmp;
...
// Start of branch "x"
							if (x != null) {
								...
								if (x.fechaKey != null) {
									sb_tFileOutputDelimited_1.append(x.fechaKey);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (x.airlineKey != null) {
									sb_tFileOutputDelimited_1.append(x.airlineKey);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (x.Flight_Number_Operating_Airline != null) {
									sb_tFileOutputDelimited_1.append(x.Flight_Number_Operating_Airline);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (x.OriginAirportID != null) {
									sb_tFileOutputDelimited_1.append(x.OriginAirportID);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (x.OriginCityName != null) {
									sb_tFileOutputDelimited_1.append(x.OriginCityName);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (x.OriginState != null) {
									sb_tFileOutputDelimited_1.append(x.OriginState);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (x.OriginStateName != null) {
									sb_tFileOutputDelimited_1.append(x.OriginStateName);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (x.DestAirportID != null) {
									sb_tFileOutputDelimited_1.append(x.DestAirportID);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (x.DestCityName != null) {
									sb_tFileOutputDelimited_1.append(x.DestCityName);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (x.DestState != null) {
									sb_tFileOutputDelimited_1.append(x.DestState);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (x.DestStateName != null) {
									sb_tFileOutputDelimited_1.append(x.DestStateName);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (x.CRSDepTime != null) {
									sb_tFileOutputDelimited_1.append(x.CRSDepTime);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (x.DepTime != null) {
									sb_tFileOutputDelimited_1.append(x.DepTime);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (x.delayed != null) {
									sb_tFileOutputDelimited_1.append(x.delayed);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (x.DepDelayMinutes != null) {
									sb_tFileOutputDelimited_1.append(x.DepDelayMinutes);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (x.ArrDelayMinutes != null) {
									sb_tFileOutputDelimited_1.append(x.ArrDelayMinutes);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (x.WheelsOff != null) {
									sb_tFileOutputDelimited_1.append(x.WheelsOff);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (x.WheelsOn != null) {
									sb_tFileOutputDelimited_1.append(x.WheelsOn);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (x.CRSArrTime != null) {
									sb_tFileOutputDelimited_1.append(x.CRSArrTime);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (x.ArrTime != null) {
									sb_tFileOutputDelimited_1.append(x.ArrTime);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (x.Cancelled != null) {
									sb_tFileOutputDelimited_1.append(x.Cancelled);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (x.Diverted != null) {
									sb_tFileOutputDelimited_1.append(x.Diverted);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (x.CRSElapsedTime != null) {
									sb_tFileOutputDelimited_1.append(x.CRSElapsedTime);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (x.ActualElapsedTime != null) {
									sb_tFileOutputDelimited_1.append(x.ActualElapsedTime);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (x.AirTime != null) {
									sb_tFileOutputDelimited_1.append(x.AirTime);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (x.CarrierDelay != null) {
									sb_tFileOutputDelimited_1.append(x.CarrierDelay);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (x.WeatherDelay != null) {
									sb_tFileOutputDelimited_1.append(x.WeatherDelay);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (x.NASDelay != null) {
									sb_tFileOutputDelimited_1.append(x.NASDelay);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (x.SecurityDelay != null) {
									sb_tFileOutputDelimited_1.append(x.SecurityDelay);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (x.LateAircraftDelay != null) {
									sb_tFileOutputDelimited_1.append(x.LateAircraftDelay);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (x.DivAirportLandings != null) {
									sb_tFileOutputDelimited_1.append(x.DivAirportLandings);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (x.DivReachedDest != null) {
									sb_tFileOutputDelimited_1.append(x.DivReachedDest);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (x.DivActualElapsedTime != null) {
									sb_tFileOutputDelimited_1.append(x.DivActualElapsedTime);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (x.DivArrDelay != null) {
									sb_tFileOutputDelimited_1.append(x.DivArrDelay);
								}
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				parcial3_ge11002.upload_fact_0_1.upload_fact childJob_tRunJob_1 = new parcial3_ge11002.upload_fact_0_1.upload_fact();
				// pass DataSources
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// outputs:()
				// linked node: tMap_1 - inputs:(row1,row3,row2) outputs:(x)
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "C:/Parcial3/Access/dimFecha.csv";
					...
					while (fid_tFileInputDelimited_1 != null && fid_tFileInputDelimited_1.nextRecord()) {
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"fechaKey", "row3", temp, ex_tFileInputDelimited_1),
							...
							row3.fullDate = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 2;

							row3.nombreDia = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"diaDeSemana", "row3", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"numDiaEnMes", "row3", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"mes", "row3", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
							...
							row3.nombreMes = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"numSemanaEnMes", "row3", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"numSemanaEnAnio", "row3", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"trimestre", "row3", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							row3.nombreTrimestre = fid_tFileInputDelimited_1
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"diaLaboral", "row3", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"anio", "row3", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					Object filename_tFileInputDelimited_2 = "C:/Parcial3/Access/dimAerolinea.csv";
					...
					while (fid_tFileInputDelimited_2 != null && fid_tFileInputDelimited_2.nextRecord()) {
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"airlineKey", "row2", temp, ex_tFileInputDelimited_2),
							...
							row2.airlineID = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
...
// Start of branch "row2"
	...
	public static void main(String[] args) {
		final fact_vuelo_ fact_vuelo_Class = new fact_vuelo_();

		int exitCode = fact_vuelo_Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = fact_vuelo_.class.getClassLoader()
					.getResourceAsStream("parcial3_ge11002/fact_vuelo__0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = fact_vuelo_.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : fact_vuelo_");
		}
...
/************************************************************************************************
 * 214809 characters generated by Talend Open Studio for Data Integration on the
 * October 30, 2023, 12:27:14 AM CST
 ************************************************************************************************/