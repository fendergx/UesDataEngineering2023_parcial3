...
package parcial3_ge11002.run_0_1;
 ...
 * @status
 */
public class run implements TalendJob {
	...
	private final String jobName = "run";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(run.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				parcial3_ge11002.flights_stagging_0_1.flights_stagging childJob_tRunJob_1 = new parcial3_ge11002.flights_stagging_0_1.flights_stagging();
				// pass DataSources
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				parcial3_ge11002.date_stagging_0_1.date_stagging childJob_tRunJob_2 = new parcial3_ge11002.date_stagging_0_1.date_stagging();
				// pass DataSources
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				parcial3_ge11002.airlines_stagging_0_1.airlines_stagging childJob_tRunJob_3 = new parcial3_ge11002.airlines_stagging_0_1.airlines_stagging();
				// pass DataSources
	...
	public static void main(String[] args) {
		final run runClass = new run();

		int exitCode = runClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = run.class.getClassLoader()
					.getResourceAsStream("parcial3_ge11002/run_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = run.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : run");
		}
...
/************************************************************************************************
 * 43974 characters generated by Talend Open Studio for Data Integration on the
 * October 29, 2023, 6:57:48 PM CST
 ************************************************************************************************/